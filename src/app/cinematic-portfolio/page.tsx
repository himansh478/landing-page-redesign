...
const cinematicHighlights = [
  {
    id: 1,
    title: 'Cinematic Protocol Alpha',
    thumbnail: 'https://api.microlink.io/?url=https://www.instagram.com/reel/DM1i55cyoue/&screenshot=true&meta=false&embed=screenshot.url',
    videoUrl: 'https://www.instagram.com/reel/DM1i55cyoue/embed',
    category: 'Film',
    duration: '3:00',
  },
  {
    id: 2,
    title: 'Visual Synthesis Beta',
    thumbnail: 'https://api.microlink.io/?url=https://www.instagram.com/reel/DMMhCJLymoi/&screenshot=true&meta=false&embed=screenshot.url',
    videoUrl: 'https://www.instagram.com/reel/DMMhCJLymoi/embed',
    category: 'Art',
    duration: '2:30',
  }
];

export default function CinematicPortfolioPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-900 selection:bg-purple-500/30">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-0 left-0 w-[800px] h-[800px] bg-pink-600/5 blur-[150px] rounded-full" />
      </div>
      ...
      <section className="relative pt-40 pb-32">
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="text-center mb-32">
            ...
            >
              Cinematic <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-slate-900 via-purple-600 to-purple-500">Portfolio.</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Architecting <span className="text-slate-900 font-medium">breathtaking visuals</span> through Hollywood-grade equipment and immersive storytelling.
            </motion.p>
          </div>

          {/* Highlights Grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-12 mb-32">
            {cinematicHighlights.map((video, idx) => (
              <motion.div
                key={video.id}
                initial={{ opacity: 0, y: 20 }}
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
              <div>
                <div className="flex items-center justify-center lg:justify-start gap-3 mb-6">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-400">Premium Production</span>
                </div>
                <h2 className="text-4xl md:text-6xl font-bold mb-6 tracking-tighter leading-none">Capture The <br /> <span className="text-purple-500">Epic.</span></h2>
