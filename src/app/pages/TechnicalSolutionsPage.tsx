...
function TechnicalSolutionForm({
  service,
  onClose,
}: TechnicalSolutionFormProps) {
    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          {/* Header */}
          <div
            className={`sticky top-0 bg-slate-50 p-8 flex items-center justify-between z-10 border-b border-slate-100`}
          >
            <div>
              <h2 className="text-3xl font-black text-slate-900 tracking-tight">
                Book {service.title}
              </h2>
              <p className="text-slate-500 font-light mt-1 text-base">
                Fill in your details to get started with our technical team.
              </p>
            </div>
            <button
              onClick={onClose}
              className="p-3 hover:bg-slate-100 rounded-full transition-colors text-slate-500"
            >
              <X className="w-6 h-6" />
            </button>
          </div>
            ...
            {isSubmitted ? (
              ...
              >
                ...
                <p className="text-slate-500 text-center max-w-sm font-light text-lg">
                  Thank you for booking {service.title}. We'll contact you
                  shortly on your WhatsApp number.
                </p>
              </motion.div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <label className="block text-slate-900 font-bold uppercase tracking-widest text-[10px]">
                      Full Name *
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl text-slate-900 placeholder-slate-400 focus:border-blue-500 focus:bg-white focus:outline-none transition-all"
                    />
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      required
                      className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl text-slate-900 focus:border-blue-500 focus:bg-white focus:outline-none transition-all appearance-none"
                    >
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl text-slate-900 placeholder-slate-400 focus:border-blue-500 focus:bg-white focus:outline-none transition-all resize-none"
                  />
                </div>
...
export function TechnicalSolutionsPage() {
  ...
  const handleBookNow = (service: TechnicalService) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {technicalServices.map((service, index) => (
            ...
            >
              ...
              {/* Content */}
              <h3 className="text-2xl font-black text-slate-900 mb-2 relative z-10 uppercase tracking-tight">
                {service.title}
              </h3>

              <p className="text-slate-500 mb-6 text-base font-light relative z-10">
                {service.description}
              </p>
