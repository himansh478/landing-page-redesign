...
const themes = [
  {
    id: 1, title: 'KGF Theme', icon: <Crown className="w-8 h-8" />,
    ...
    gradient: 'from-amber-600 to-orange-800', price: 'Starting at ₹25,000',
  },
  {
    id: 2, title: 'Pushparaj Theme', icon: <Film className="w-8 h-8" />,
    ...
    gradient: 'from-red-600 to-rose-800', price: 'Starting at ₹25,000',
  },
  {
    id: 3, title: 'Trader Theme', icon: <Clapperboard className="w-8 h-8" />,
    ...
    gradient: 'from-blue-600 to-indigo-800', price: 'Starting at ₹20,000',
  },
  {
    id: 4, title: 'South Indian Theme', icon: <Music className="w-8 h-8" />,
    ...
    gradient: 'from-green-600 to-emerald-800', price: 'Starting at ₹22,000',
  },
  {
    id: 5, title: 'Rajasthan Theme', icon: <Mountain className="w-8 h-8" />,
    ...
    gradient: 'from-orange-600 to-red-800', price: 'Starting at ₹22,000',
  },
  {
    id: 6, title: 'Western Theme', icon: <Camera className="w-8 h-8" />,
    ...
    gradient: 'from-purple-600 to-pink-800', price: 'Starting at ₹30,000',
  },
];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-20">
            {themes.map((theme, index) => (
              ...
              >
                ...
                <h3 className="text-3xl font-black text-slate-900 mb-4 relative z-10 uppercase tracking-tight">{theme.title}</h3>
                <p className="text-slate-500 text-lg font-light mb-8 relative z-10 leading-relaxed">{theme.description}</p>
