...
export function Footer() {
  return (
    <footer className="relative overflow-hidden bg-slate-50 border-t border-slate-200">
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-40 bg-indigo-500/5 blur-[80px] rounded-full pointer-events-none" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 sm:pt-20 pb-8 sm:pb-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-12 mb-12 sm:mb-16">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <span
                className="text-slate-900 text-2xl font-black tracking-tight text-gradient"
            ...
            <div className="flex gap-2.5">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-lg flex items-center justify-center transition-all bg-white border border-slate-200 text-slate-500 hover:bg-green-500 hover:border-transparent hover:text-white hover:scale-110 shadow-sm"
                aria-label="WhatsApp"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-lg flex items-center justify-center transition-all bg-white border border-slate-200 text-slate-500 hover:bg-red-600 hover:border-transparent hover:text-white hover:scale-110 shadow-sm"
                aria-label="YouTube"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-lg flex items-center justify-center transition-all bg-white border border-slate-200 text-slate-500 hover:bg-blue-500 hover:border-transparent hover:text-white hover:scale-110 shadow-sm"
                aria-label="Telegram"
              >
          ...
          <div>
            <h3
              className="text-slate-900 font-bold mb-5 text-xs tracking-widest uppercase"
              style={{ fontFamily: 'Outfit, Inter, sans-serif' }}
            >
              Services
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-slate-500 text-sm">
                <Mail className="w-4 h-4 mt-0.5 flex-shrink-0 text-indigo-500" />
                <a href="mailto:Sudhanshugour89@gmail.com" className="hover:text-indigo-600 transition-colors break-all">
                  Sudhanshugour89@gmail.com
                </a>
              </li>
              <li className="flex items-start gap-3 text-slate-500 text-sm">
                <Phone className="w-4 h-4 mt-0.5 flex-shrink-0 text-indigo-500" />
        ...
        <div className="pt-6 border-t border-slate-200 flex flex-col sm:flex-row justify-between items-center gap-4 text-center sm:text-left">
          ...
          <div className="flex gap-5 text-xs flex-wrap justify-center">
            <Link href="/privacy-policy" className="text-slate-400 hover:text-indigo-600 transition-colors">
              Privacy Policy
            </Link>
            <Link href="/terms-conditions" className="text-slate-400 hover:text-indigo-600 transition-colors">
              Terms & Conditions
            </Link>
            <Link href="/privacy-policy#cookies" className="text-slate-400 hover:text-indigo-600 transition-colors">
              Cookie Policy
            </Link>
          </div>
        </div>
