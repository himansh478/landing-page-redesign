...
import { socialVideoHighlights } from './socialVideoHighlights.ts';
import { PortfolioVideo } from './commercialHighlights.ts';

export function SocialVideoPortfolioPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="sticky top-0 z-50 bg-white/80 backdrop-blur-lg border-b border-slate-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <Link 
            ...
            className="inline-flex items-center gap-2 text-slate-500 hover:text-pink-600 font-bold transition-colors group"
          >
      ...
      {/* Hero Section */}
      <section className="py-20 bg-[radial-gradient(circle_at_top_right,rgba(219,39,119,0.05)_0%,transparent_50%)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-6xl md:text-8xl font-black text-slate-900 mb-8 tracking-tight">
              Social Video <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-rose-600">Portfolio</span>
            </h1>
            <p className="text-xl md:text-2xl text-slate-500 max-w-3xl mx-auto font-light leading-relaxed">
              Instagram Reels and YouTube Shorts designed for maximum viral potential and engagement.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-12">
            <h2 className="text-4xl font-black text-slate-900 tracking-tight">Social <span className="text-pink-600">Highlights</span></h2>
                ...
                <div className="relative w-full aspect-[9/16] bg-slate-100 p-1">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500 transform scale-50 group-hover:scale-100">
                    <div className="w-16 h-16 bg-white text-pink-600 rounded-full flex items-center justify-center shadow-2xl">
                      <Play className="w-7 h-7 fill-pink-600 text-pink-600" />
                    </div>
                  </div>
                </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            <h2 className="text-5xl md:text-7xl font-black text-white mb-8 tracking-tight leading-[1.1]">
              Go <span className="text-pink-400">Viral</span>
            </h2>
            ...
            <div className="flex gap-6 flex-wrap justify-center">
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="bg-pink-600 text-white px-10 py-5 rounded-2xl text-xl font-black shadow-2xl shadow-pink-500/40 transition-all hover:bg-pink-500 active:scale-95 uppercase tracking-widest text-sm"
              >
                Get Started
              </motion.button>
            </div>
