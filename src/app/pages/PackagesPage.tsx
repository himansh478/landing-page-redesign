...
const faqs = [
  { q: 'How soon can I get my edited video?', a: 'Depending on the package, you can get your video in as little as 3-4 hours after the shoot!' },
  { q: 'Do you travel for shoots?', a: 'Yes, we travel to your location. Travel charges may apply depending on the package.' },
  { q: 'Can I get a custom package?', a: 'Absolutely! We can tailor a package specific to your needs. Just book a discovery call.' },
];

const serviceTags = ['Car Delivery', 'Events', 'Business Promo', 'Wedding', 'Cinematic'];
